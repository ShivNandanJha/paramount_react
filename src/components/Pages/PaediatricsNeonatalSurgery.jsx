        ...
        <div className="row cs_dept_blog">
          <div className="col-lg-8">
            <div className="cs_blog_details">
              ...
              <p>
                Yhe hospital&apos;s pediatric and neonatal units are equipped
                with state-of-the-art facilities. This includes advanced
                diagnostic and imaging equipment, minimally invasive surgical
                tools, and cutting-edge technologies that aid in the diagnosis
                and treatment of complex pediatric conditions. Paramount
                Hospital ensures that the smallest patients have access to the
                best resources available.
              </p>
              <h2>Patient-Centric Pediatric Care </h2>
              <p>
                Beyond the technical expertise, Paramount Hospital places a
                strong emphasis on patient-centric care in the field of
                pediatrics and neonatal surgery. The hospital is dedicated to
                ensuring that both young patients and their parents feel
                comfortable, informed, and well-supported throughout their
                healthcare journey. Child-friendly environments, child life
                specialists, and clear communication are hallmarks of the
              ...
              <h2>Highly Skilled Pediatric Surgeons</h2>
              <p>
                The cornerstone of Paramount Hospital's pediatric success is its
                team of highly skilled pediatric surgeons. These surgeons are
                not only experts in their field but also have a deep
                understanding of the unique needs and challenges associated with
                treating children and neonates. Their expertise spans a wide
                range of pediatric surgical procedures, and their commitment to
                patient care is unwavering.
              </p>
            </div>
          </div>
        </div>
