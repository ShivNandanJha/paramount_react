    ...
    <>
      ...
      <Section topMd={135} topLg={100} topXl={100}>
        <AboutSectionStyle2
          ...
          imgUrl="/images/departments/ent.webp"
        />
      </Section>
        ...
        <div className="row cs_dept_blog">
          <div className="col-lg-8">
            <div className="cs_blog_details">
              Paramount hospital&apos;s ENT department is dedicated to
              addressing the unique needs of patients experiencing a wide
              spectrum of ear, nose, and throat issues. These conditions can
              range from common ear infections to complex head and neck cancers,
              and the hospital is committed to providing top-quality care
              throughout the journey to recovery.
              <br /> <br />
              <h2>State-of-the-Art Facilities at Paramount Hospital</h2>
              <p>
                The hospital&apos;s ENT department is distinguished by its
                state-of-the-art facilities. Equipped with advanced diagnostic
                tools, cutting-edge surgical equipment, and innovative
                techniques, Paramount Hospital ensures that patients have access
                to the latest advancements in ENT care. From hearing tests to
                sinus surgeries, the hospital is well-prepared to deliver
                world-class treatment.{" "}
              </p>
              <h2> Highly Skilled ENT Specialists</h2>
              <p>
                The success of Paramount hospital&apos;s ENT department relies
                on its team of highly skilled ENT specialists. These
                professionals are not only experts in their field but also have
                a deep understanding of the intricate structures and functions
                of the ear, nose, and throat. Their expertise spans a wide range
                of services, and they are dedicated to providing compassionate
                and effective care.
              </p>
              <h2> Allergy and Immunotherapy</h2>
              <p>
                The hospital provides comprehensive allergy testing and
                immunotherapy options for patients dealing with allergic
                rhinitis and related conditions. Managing allergies is crucial
                for overall ENT health, and Paramount Hospital offers tailored
                treatment plans.
              </p>
              <blockquote
                style={{
              ...
              <h2>Comprehensive Swallowing Disorder Care</h2>
              <p>
                Paramount hospital&apos;s ENT specialists excel in the diagnosis
                and management of swallowing disorders (dysphagia), ensuring
                that patients receive the appropriate care to improve their
