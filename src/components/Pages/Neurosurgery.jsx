            ...
            <div className="cs_blog_details">
              ...
              <ol>
                ...
                <li>
                  ...
                  <br />
                  We offer a wide range of neurosurgical treatments, including
                  but not limited to: <br />
                  Brain surgery for tumors, vascular conditions, and epilepsy{" "}
                  <br />
                  Spinal surgery for herniated discs, spinal stenosis, and
                  deformities <br />
                  Minimally invasive neurosurgery for reduced pain and faster
                  recovery <br />
                  Cranial and spinal trauma surgery for injuries <br />
                  Complex skull base surgery for tumors and vascular issues{" "}
                  <br />
                  Peripheral nerve surgery for conditions like carpal tunnel
                  syndrome <br />
                </li>
                <li>
              ...
              <p>
                We recognize that facing a neurosurgical procedure can be
                daunting. Paramount Hospital's neurosurgical team is committed
                to providing compassionate care, addressing your concerns, and
                ensuring you have a clear understanding of your treatment plan.
              </p>
              <blockquote
                style={{
