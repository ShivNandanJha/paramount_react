    ...
    <>
      ...
      <Section topMd={135} topLg={100} topXl={100}>
        <AboutSectionStyle2
          ...
          imgUrl="/images/departments/orthopaedic.webp"
        />
      </Section>
        ...
        <div className="row cs_dept_blog">
          <div className="col-lg-8">
            <div className="cs_blog_details">
              <h2>
                Orthopaedic Excellence at Paramount Hospital: <br /> Restoring
                Mobility, Enhancing Lives{" "}
              </h2>
              At Paramount Hospital, we offer a comprehensive range of
              orthopaedic services to address a wide variety of musculoskeletal
              issues, including:
              <ol>
                <li>
                  <b>Joint Replacement: </b>
                  <br />
                  Our experienced orthopaedic surgeons perform state-of-the-art
                  joint replacement surgeries, including hip, knee, and shoulder
                  replacements, using the latest techniques and prosthetic
                  materials.
                </li>
                <li>
                  <b>Sports Medicine: </b> <br />
                  We provide specialized care for athletes and individuals with
                  sports-related injuries, offering a multidisciplinary approach
                  to rehabilitation and performance enhancement.{" "}
                </li>
                <li>
                  <b>Spine Care: </b>
                  <br />
                  Our spine specialists diagnose and treat spinal conditions,
                  such as herniated discs, spinal stenosis, and scoliosis,
                  employing both surgical and non-surgical approaches.
                </li>
                <li>
                  <b>Trauma and Fracture Care: </b>
                  <br />
                  We are equipped to handle traumatic injuries and fractures,
                  offering immediate care and comprehensive fracture management.
                </li>
                <li>
                  <b>Arthroscopy: </b> <br />
                  Our orthopaedic surgeons use minimally invasive arthroscopic
                  techniques to diagnose and treat joint problems, reducing pain
                  and recovery time.
                </li>
                <li>
                  <b>Pediatric Orthopaedics: </b> <br />
                  Paramount Hospital provides specialized care for children with
                  musculoskeletal conditions, ensuring they receive
                  age-appropriate treatment and support.{" "}
                </li>
              </ol>
              <h2> State-of-the-Art Facilities at Paramount Hospital</h2>
              <p>
                Our orthopaedic department is equipped with state-of-the-art
                diagnostic tools and surgical facilities, enabling us to provide
                accurate assessments and perform advanced surgical procedures
                with precision. We employ the latest imaging technologies,
                including MRI and CT scans, to ensure the most accurate
                diagnoses.
              </p>
              <blockquote
                style={{
              ...
              <p>
                Paramount Hospital is dedicated to delivering patient-centered
                care that addresses not only the physical aspects of orthopaedic
                conditions but also the emotional and psychological well-being
                of our patients. We believe that effective communication and a
                compassionate approach are essential components of successful
